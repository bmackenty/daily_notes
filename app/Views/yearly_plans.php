        ...
        <div class="col-md-12">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><?= htmlspecialchars($course['name']) ?> Yearly Plan</li>
                </ol>
            </nav>
            ...
            <div class="card mb-5">
                <div class="card-header bg-light">
                    <h3 class="h5 mb-0">
                        ...
                        Yearly Plan for <?= htmlspecialchars($course['name']) ?>
                    </h3>
                </div>
                <div class="card-body">
                    <?php if (empty($plans)): ?>
                        <div class="alert alert-info">
                            No yearly plan has been set for this course yet.
                        </div>
                    <?php else: ?>
                        <div class="accordion" id="yearlyPlansAccordion">
                            <?php foreach ($plans as $plan): ?>
                                <div class="accordion-item">
                                    ...
                                    <div id="collapse<?= $plan['academic_week_id'] ?>" 
                                         ...
                                         data-bs-parent="#yearlyPlansAccordion">
